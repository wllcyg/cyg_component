...
const HeadCrop = () => {
    ...
    const getImage = () => {
        ...
        let client_w = drapValue.dBoxWidth / drapValue.wrapWidth * currentImage.w
        let client_h = drapValue.dBoxHeight / drapValue.wrapHeight * currentImage.h
        ...
        <Card>
            <div className='flex justify-center items-center'>
                ...
                <div className='flex flex-col '>
                    <canvas className='mb-7' ref={canvasRef} width={drapValue.canvasW} height={drapValue.canvasH}></canvas>
